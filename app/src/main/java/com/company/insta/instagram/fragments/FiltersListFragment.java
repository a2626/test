...
import com.company.insta.instagram.adapter.ThumbnailsAdapter;
import com.company.insta.instagram.helper.SpacesItemDecoration;
        ...
        Runnable r = new Runnable() {
            public void run() {
                ...
                if (bitmap_ == null) {
                    ...
                    bitmap_ = bitmapDrawable.getBitmap();
                }

                thumbImage = Bitmap.createScaledBitmap(bitmap_, 100, 100, false);
